...
public enum ItemTier {
	...
	public io.github.vexytal.enums.ItemTier getDRTier(){
		switch(this){
			case T1:
				return io.github.vexytal.enums.ItemTier.T1;
			case T2:
				return io.github.vexytal.enums.ItemTier.T2;
			case T3:
				return io.github.vexytal.enums.ItemTier.T3;
			case T4:
				return io.github.vexytal.enums.ItemTier.T4;
			case T5:
				return io.github.vexytal.enums.ItemTier.T5;
		}
